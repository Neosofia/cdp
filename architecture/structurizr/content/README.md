...
![Authentication - Process Flow](authentication-flow.png)

![Authorization - Process Flow](authorization-flow.png)
...
![App and Service Flow](app-flow.png)
...
![Audit & Immutability Process Flow](audit-flow.png)
...
Technical alignment and regulatory compliance (like HIPAA) are governed by our [`architecture/constitution.md`](architecture/constitution.md), the ADR catalog in [`architecture/adrs/`](/workspace/1/decisions), and Spec-based service designs. These principles are supported by companion governance artifacts in [`corporate`](https://github.com/Neosofia/corporate) and the broader Neosofia repo portfolio.
...
![CDP Platform - Patient Flow](patient-flow.png)


#### Clinician Escalation/Response Process
![CDP Platform - Clinician Flow](clinician-flow.png)
...
![CDP Platform - System Landscape](system-landscape.png)
