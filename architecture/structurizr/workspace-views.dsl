        ...
        dynamic cdp "PatientChatFlow" {
            ...
            careEpisodeService -> chatService "Completions proxy; persist patient and assistant messages"
            chatService -> groq "Care assistant inference"
            careEpisodeService -> groq "Clinical risk evaluation"
