...
The authoritative list, assigner rules (which actor classes may grant which types), and deploy-time product vocabulary live in the User service role catalog. CDP labels and UI vocabulary: [policies/user/role-catalog.json](../policies/user/role-catalog.json) ([policies/README.md](../policies/README.md)). Platform base: none in the user repo; CDP supplies [policies/user/role-catalog.json](../policies/user/role-catalog.json) via `ROLE_CATALOG_OVERLAY`.
...
- Role catalog vocabulary: [policies/README.md](../policies/README.md) (CDP product catalog via `ROLE_CATALOG_OVERLAY`)
