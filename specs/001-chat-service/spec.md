...
- **CareEpisode**: Owned by **015 Care Episode Service**; referenced here by `care_episode_id` only. Consult `015-care-episode-service/spec.md` for the canonical schema.
