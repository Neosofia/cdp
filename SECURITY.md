...
For general SDLC and secure coding practices (including configuration, input validation, supply chain controls, and testing), see the [Neosofia SDLC Best Practices](https://github.com/Neosofia/corporate/blob/main/resources/checklists/sdlc.md).
...
- **Identity Delegation:** We never implement our own credential storage, MFA, or password policy. All human identity is delegated to a HIPAA-eligible identity provider ([ADR-0007](architecture/adrs/0007-never-roll-your-own-authentication.md)).
...
| Service | Document |
|---|---|
| Authentication | [authentication SECURITY.md](https://github.com/Neosofia/authentication/blob/main/SECURITY.md) — OAuth 2.0 / PKCE flow, JWT signing, session management, rate limiting, and full threat model |
